...
extern "C" {
    ...
    /* Allocates descriptor for code conversion from encoding ÅefromcodeÅf to
       encoding ÅetocodeÅf. */
...
#define iconv_open libiconv_open
    ...
    /* Converts, using conversion descriptor ÅecdÅf, at most Åe*inbytesleftÅf bytes
       starting at Åe*inbufÅf, writing at most Åe*outbytesleftÅf bytes starting at
       Åe*outbufÅf.
       Decrements Åe*inbytesleftÅf and increments Åe*inbufÅf by the same amount.
       Decrements Åe*outbytesleftÅf and increments Åe*outbufÅf by the same amount. */
#ifndef LIBICONV_PLUG
#define iconv libiconv
#endif
    extern size_t iconv(iconv_t cd, char** inbuf, size_t* inbytesleft, char** outbuf, size_t* outbytesleft);

    /* Frees resources allocated for conversion descriptor ÅecdÅf. */
#ifndef LIBICONV_PLUG
...
extern "C" {
    ...
    /* Allocates descriptor for code conversion from encoding ÅefromcodeÅf to
       encoding ÅetocodeÅf into preallocated memory. Returns an error indicator
